...
public class Config implements Initializer {
    ...
    public Config(AntiCheatX plugin) {
        this.plugin = plugin;
    }
    ...
    public enum Setting {
        ...
        THEME("theme", "default", "The theme that the anticheatx is going to use"),
        ...
        GHOST_MODE("ghost_mode", true, "Should we enable the Ghost Mode?", "If enabled the AntiCheatX will use Setbacks for movement related checks"),
