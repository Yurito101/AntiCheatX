...
import me.yurito.anticheatx.checks.types.annotations.Development;
import me.yurito.anticheatx.checks.types.annotations.Experimental;
...
import me.yurito.anticheatx.utils.BetterStream;
...
public abstract class AbstractCheck {
    ...
    public AbstractCheck(Profile profile, CheckType check, String type, String description) {
        ...
        final CommentedFileConfiguration config = AntiCheatX.getInstance().getChecks();
