...
import me.yurito.anticheatx.nms.NmsInstance;
import me.yurito.anticheatx.playerdata.data.Data;
import me.yurito.anticheatx.playerdata.processors.impl.SetbackProcessor;
import me.yurito.anticheatx.processors.Packet;
import me.yurito.anticheatx.utils.CollisionUtils;
import me.yurito.anticheatx.utils.MoveUtils;
import me.yurito.anticheatx.utils.custom.CustomLocation;
import me.yurito.anticheatx.utils.custom.Equipment;
import me.yurito.anticheatx.utils.fastmath.FastMath;
import me.yurito.anticheatx.wrappers.WrapperPlayClientLook;
import me.yurito.anticheatx.wrappers.WrapperPlayClientPosition;
import me.yurito.anticheatx.wrappers.WrapperPlayClientPositionLook;
...
public class MovementData implements Data {
    ...
    private void processPlayerData() {
        ...
        NmsInstance nms = AntiCheatX.getInstance().getNmsManager().getNmsInstance();
