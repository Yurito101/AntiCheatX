package me.yurito.anticheatx.managers.threads;
...
import me.yurito.anticheatx.utils.custom.exception.AnticheatException;
...
public class ThreadManager implements Listener, Initializer {
    ...
    public ThreadManager(AntiCheatX plugin) {
        this.plugin = plugin;
    }

    @Override
    public void initialize() {
        Bukkit.getPluginManager().registerEvents(this, AntiCheatX.getInstance());
    }
