...
import me.yurito.anticheatx.utils.custom.ExpiringSet;
import me.yurito.anticheatx.wrappers.WrapperPlayClientCustomPayload;
...
public class ClientBrandListener extends PacketAdapter {
    ...
    public ClientBrandListener(AntiCheatX plugin) {
